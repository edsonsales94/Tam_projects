...
_Export :=POSICIONE("SA1",1,XFILIAL("SA1")+cCliente+C5_LOJACLI,"A1_EST")     // Deixar passar clientes exportacao
...
Else
	...
	//	cQuery += "SE1.E1_SALDO > 0 AND SE1.E1_TIPO <>'NCC'AND SE1.E1_TIPO <>'RA' AND  SE1.E1_VENCREA <" +dData
	...
	IF nRec > 0
		lInad    :=.F.
		nAviso := Aviso("Aten็ใo", "Cliente inadimplente pedido bloqueado"+CRLF+;
