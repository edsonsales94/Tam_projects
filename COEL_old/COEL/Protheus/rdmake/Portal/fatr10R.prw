...
±±³Programa  ³ FATR10   ³ Autor ³ Sergio Arruda         ³ Data ³ 03.12.04  ³±±
...
LOCAL tamanho:= "G"
LOCAL limite := 220
LOCAL titulo := "Relacao de Notas Fiscais Representante"
...
PRIVATE nomeprog:="FATR10R"
PRIVATE aLinha  := { },nLastKey := 0
PRIVATE cPerg   :="FATR10R"
...
//³ mv_par21             // TES Qto Faturamento            		 ³
//³ mv_par22             // TES Qto Estoque                		 ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
...
LOCAL cDupli	:= If( (MV_PAR21 == 1),"S",If( (MV_PAR21 == 2),"N","SN" ) )
LOCAL cEstoq	:= If( (MV_PAR22 == 1),"S",If( (MV_PAR22 == 2),"N","SN" ) )
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
titulo := "Relacao das Notas Fiscais" + " - " + GetMv("MV_MOEDA" + STR(mv_par16,1)) + " - Gera Dup.: " + cDupli + " - Atualiz. Est.: " + cEstoq
...
While !Eof() .and. lContinua
	...
	While !Eof() .and. D2_DOC+D2_SERIE == SF2->F2_DOC+SF2->F2_SERIE
		...
		ElseIf mv_par15 == 3
			dbSelectArea("SC6");dbSetOrder(1);dbSeek(xFilial()+SD2->D2_PEDIDO+SD2->D2_ITEMPV)
			@li , 16 PSAY Substr(C6_DESCRI,1,29)
		Else
...
Cabec1	:= STR0018 //"PRODUCTO         DESCRIPCIàN                      DEP. PEDIDO/IT  REMITO/ITEM        CANTIDAD    VALOR UNITARIO  VALOR MERCADERIA     GRAVAMENES NO        GRAVAMENES      OTROS GASTOS               TOTAL"
...
PutSx1("MTR550","19","De Cliente?","¿De Cliente ?","From Customer?","mv_chj","C",6,0,0,"G","","CLI","001","","mv_par19","","","",""," "," "," "," "," "," "," "," "," ","","","",{},{},{},".MTR26506.")
PutSx1("MTR550","20","Ate Cliente?","¿A Cliente ?","To Customer ? ","mv_chk","C",6,0,0,"G","","CLI","001","","mv_par20","","","","ZZZZZZ"," "," "," "," "," "," "," "," "," ","","","",{},{},{},".MTR26507.")
