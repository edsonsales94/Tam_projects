...
cSELECT := 	' SC5.C5_NUM, SC5.C5_EMISSAO,SC5.C5_CLIENTE, SC5.C5_LOJACLI, SC5.C5_LOJAENT,SA1.A1_COD,SA1.A1_NOME,SA1.A1_LOJA,SA1.A1_CGC,SA1.A1_INSCR,SA1.A1_END,SA1.A1_BAIRRO,SA1.A1_MUN, '+;
...
While 	TRA->( ! Eof() )
   ...
   Endif
    ...
    If TRA->C5_LOJACLI == TRA->C5_LOJAENT
    	cLocEnt := TRA->A1_ENDENT
    Else
        If SA1->(DBSETORDER(1), DBSEEK(XFILIAL()+ TRA->C5_CLIENTE+TRA->C5_LOJAENT))
        	cLocEnt := SA1->A1_ENDENT
        Endif
    Endif
	cMunEnt := TRA->A1_MUNE
