...
=========================================================================================================
Programa.: VldCndPg
Autor....: Evaldo V. Batista
Data.....: 13/10/2015
Objetivo.: Ajustar a Tabela do Pedido de vendas conforme a condição de pagamento
Descrição: 
Uso......: SIGAFAT
         : Acrescentar no campo C5_CONDPAG a validação de usuário (X3_VLDUSER) a função: U_VldCndPg() 
=========================================================================================================
*/

User Function VldCndPg()
Local lRet			:= .T.
Local aArea			:= GetArea()
...
If Type('M->C5_CONDPAG') <> 'U' .and. ! Empty(M->C5_CONDPAG)
		...
		If DA0->(dbSeek(xFilial('DA0') + SE4->E4_TABELA))
			If Type('M->C5_TABELA') <> 'U'
			   IF cGcond < "500" 
				...
				If MaVldTabPrc(SE4->E4_TABELA,M->C5_CONDPAG,,M->C5_EMISSAO)
