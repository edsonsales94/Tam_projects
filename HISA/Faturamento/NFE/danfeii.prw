...
#DEFINE MAXITEMC   038                                                // Máxima de caracteres por linha de produtos/serviços //038
#DEFINE MAXMENLIN  090                                                // Máximo de caracteres por linha de dados adicionais //88 HISAMITSU
#DEFINE MAXMSG     013                                                // Máximo de dados adicionais por página
#DEFINE MAXVALORC  010                                                // Máximo de caracteres por linha de valores numéricos //090 HISAMITSU
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	For nZ := 1 To nLenDet
		...
		*** CUSTUMIZAÇÃO PARA OS CLIENTES 000032 E 000038
		*** Edson sales
		
			nVTotal  := Val(oDet[nX]:_Prod:_vProd:TEXT)//-Val(IIF(Type("oDet[nPrivate]:_Prod:_vDesc")=="U","",oDet[nX]:_Prod:_vDesc:TEXT))
			IF	SF2->F2_FILIAL=='01' .AND. SF2->F2_CLIENTE $ '000032|000038' .and.;
					AllTrim(oDet[nX]:_Prod:_cProd:text) $  SuperGetMV("MV_PRSEGUM")// NF saida E cliente
				nVUnit   := Val(oDet[nX]:_Prod:_vUnTrib:TEXT) //HISAMITSU
			ELse
				nVUnit   := Val(oDet[nX]:_Prod:_vUnCom:TEXT) //Val(oDet[nX]:_Prod:_vUnTrib:TEXT) //HISAMITSU
			endif
		EndIf
...
*/
	...
	oDanfe:Box(217,000,237,300)
	oDanfe:Say(224,002,"ENDEREÇO",oFont08N:oFont)
	oDanfe:Say(234,002,aDest[01],oFont08:oFont)
	oDanfe:Box(217,300,237,450)
	oDanfe:Say(224,302,"BAIRRO/DISTRITO",oFont08N:oFont)
	oDanfe:Say(234,302,aDest[02],oFont08:oFont)
	oDanfe:Box(217,450,237,500)
	oDanfe:Say(224,452,"CEP",oFont08N:oFont)
	oDanfe:Say(234,452,aDest[03],oFont08:oFont)
//FIM HISAMITSU
...
//oDanfe:Say(233,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont) //HISAMITSU
	oDanfe:Box(236,502,257,603)
	oDanfe:Say(243,503,"HORA ENTRADA/SAÍDA",oFont08N:oFont)
//oDanfe:Say(252,503,aHrEnt[01],oFont08:oFont) //HISAMITSU
//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³Quadro fatura                                                           ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	aAux := {{{},{},{},{},{},{},{},{},{}}}
...
*/
	oDanfe:Box(227,000,247,300)
	oDanfe:Say(234,002,"ENDEREÇO",oFont08N:oFont)
	oDanfe:Say(244,002,aDest[01],oFont08:oFont)
	oDanfe:Box(227,300,247,450)
	oDanfe:Say(234,302,"BAIRRO/DISTRITO",oFont08N:oFont)
	oDanfe:Say(254,302,aDest[02],oFont08:oFont)
	oDanfe:Box(227,450,247,500)
	oDanfe:Say(234,452,"CEP",oFont08N:oFont)
	oDanfe:Say(244,452,aDest[03],oFont08:oFont)
//FIM HISAMITSU
...
//oDanfe:Say(243,504,Iif( Empty(aDest[4]),"",ConvDate(aDest[4]) ),oFont08:oFont) //HISAMITSU
	oDanfe:Box(246,502,267,603)
	oDanfe:Say(255,503,"HORA ENTRADA/SAÍDA",oFont08N:oFont)
//oDanfe:Say(262,503,aHrEnt[01],oFont08:oFont) // HISAMITSU
