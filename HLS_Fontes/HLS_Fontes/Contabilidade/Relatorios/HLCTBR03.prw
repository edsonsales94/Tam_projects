#INCLUDE "rwmake.ch"
/*/{protheus.doc}HLCTBR03
Relatorio Analise SD3
@author Diego Rafael
/*/
/*_______________________________________________________________________________
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
¦¦¦ Função    ¦ HLCTBR03   ¦ Autor ¦ Diego Rafael         ¦ Data ¦   /  /2010 ¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
¦¦¦ Descriçäo ¦                                                               ¦¦¦
¦¦+-----------+---------------------------------------------------------------+¦¦
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	Local cDesc3         := ""
	Local cPict          := ""
	Local titulo         := "Analise SD3"
	Local nLin           := 80
	Local Cabec1         := ""
	Local Cabec2         := ""
	Local imprime        := .T.
	Local aOrd           := {}
	Local cPerg          := PadR("ICFATR05",Len(SX1->X1_GRUPO))
	Private lEnd         := .F.
	Private lAbortPrint  := .F.
	Private CbTxt        := ""
	Private limite       := 220
	Private tamanho      := "G"
	Private nomeprog     := "ICFATR05" // Coloque aqui o nome do programa para impressao no cabecalho
	Private nTipo        := 18
	...
	Private CONTFL       := 01
	Private m_pag        := 01
	Private wnrel        := "ICFATR05" // Coloque aqui o nome do arquivo usado para impressao em disco
	Private aCabec       := {}
	Private cString      := ""
	Private aCol         := {01,19,32,48,101,119,138,176,198}

	aCabec := {{"FILIAL",17},{"DOCUMENTO",11},{"CODIGO",16},{"PRODUTO",17},{"TIPO",17},{"TM",36},{"CF",20},{"QUANT",17},{"CUSTO",20}}
...
Static Function RunReport(Cabec1,Cabec2,Titulo,nLin)
   ...
   //ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
		...
		aAdd(aLinha,(cTable)->TM)
		aAdd(aLinha,(cTable)->CF)
...
Static Function MountTable(cTable)
	...
	cQry += Chr(13) + Chr(10) + " Select D3_FILIAL FILIAL, D3_DOC DOCUMENTO, D3_COD CODIGO, B1_DESC PRODUTO, B1_TIPO TIPO, D3_TM TM, D3_CF CF, D3_QUANT QUANT, D3_CUSTO1 CUSTO  From " + RetSqlName("SD3") +" SD3"
	cQry += Chr(13) + Chr(10) + " INNER JOIN " + RetSqlName("SB1") +" SB1 ON B1_COD = D3_COD AND B1_FILIAL = D3_FILIAL AND SB1.D_E_L_E_T_ = ' ' "
	cQry += Chr(13) + Chr(10) + " WHere SD3.D_E_L_E_T_ = ' ' "
	cQry += Chr(13) + Chr(10) + " AND D3_ESTORNO = '' "
	cQry += Chr(13) + Chr(10) + " And D3_EMISSAO BetWeen '" + DTOS(mv_par01) + "' And '" + DTOS(mv_par02) + "' "
                                                    
	cQry += Chr(13) + Chr(10) + " ) A

	MemoWrit("ICFATR05.sql",cQry)
	...
	cQry += Chr(13) + Chr(10) + " order by FILIAL,DOCUMENTO, PRODUTO "
...
Static Function Exporta()
	...
	Local cArqTxt    	:= GetTempPath()+"Movimentos.xls"
