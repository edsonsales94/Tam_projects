...
User Function RELFOREC(cId, dDtBase)
/*
	Local aRet 		:= {}
	Local aPergs	:= {}
...
Static Function ReportDef(cPerg)
	...
	oReport := TReport():New("RELFOREC", cTitulo, cPerg, {|oReport| ReportPrint(oReport)}, cHelp)
	...
	//TRCell():New(oProduct, "QUANTIDADE_PC", 	/*cAlias*/, "Qtd. PC", 			PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	//TRCell():New(oProduct, "QUANTIDADE_PC2", 	/*cAlias*/, "", 				PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	TRCell():New(oProduct, "TOTAL_PC", 			/*cAlias*/, "Total PC", 		PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	//TRCell():New(oProduct, "QUANTIDADE_M1", 	/*cAlias*/, "Qtd. M1", 			PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	//TRCell():New(oProduct, "QUANTIDADE_M12", 	/*cAlias*/, "",		 			PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	TRCell():New(oProduct, "TOTAL_M1", 			/*cAlias*/, "Total M1", 		PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	//TRCell():New(oProduct, "QUANTIDADE_M2", 	/*cAlias*/, "Qtd. M2", 			PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
	//TRCell():New(oProduct, "QUANTIDADE_M22", 	/*cAlias*/, "", 				PesqPict("SC7", "C7_QUANT"), 	TamSX3("C7_QUANT")[1], 	/*Pixel*/, /*Block*/, /*Align*/, /*LineBreak*/, "RIGHT")
...
Static Function ReportPrint(oReport)
	...
	If !(cAliasQry)->(Eof())
		...
		While !(cAliasQry)->(Eof())
			...
			oProduct:Cell("MAKER_LOT"):SetValue((cAliasQry)->B1_QE)
			//oProduct:Cell("QUANTIDADE_PC"):SetValue(nPedido)
			oProduct:Cell("TOTAL_PC"):SetValue(nPedido)
			//oProduct:Cell("QUANTIDADE_M1"):SetValue(nMrpM1)
			oProduct:Cell("TOTAL_M1"):SetValue(nMrpM1)
			//oProduct:Cell("QUANTIDADE_M2"):SetValue(nMrpM2)
...
Static Function ReportQuery()
	...
	cQuery += "		SB1.B1_COD, SB1.B1_DESC, SB1.B1_QE, "+ CRLF
	...
	cQuery += "		INNER JOIN "+ RetSqlTab("SA5") +" "+ CRLF
...
Static Function Pedido(cFornec, cLoja, cProd, dDtBase)
	...
	cQuery := "SELECT "
	cQuery += "		SUM(C7_QUANT) AS QUANT "
	cQuery += "FROM "+ RetSqlTab("SC7") +" "
	cQuery += "WHERE "
	cQuery += "		"+ RetSqlDel("SC7") +" "
	cQuery += "		AND "+ RetSqlFil("SC7") +" "
	cQuery += "		AND SC7.C7_FORNECE = '"+ cFornec +"' "
	cQuery += "		AND SC7.C7_LOJA = '"+ cLoja +"' "
	cQuery += "		AND SC7.C7_PRODUTO = '"+ cProd +"' "
	cQuery += "		AND SC7.C7_DATPRF = '"+ Left(DToS(dDtBase), 6) +"01'"
