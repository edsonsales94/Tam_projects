...
Static Function Processar()
	...
	MPSysOpenQuery( cQuery, "SQL1" ) // DbUseArea(.T.,"TopConn",TcGenQry(,,cQuery),"SQL1",.T.,.T.)
	...
	While SQL1->(!Eof())
		...
		MPSysOpenQuery( cQuery, "SQL2" ) // DbUseArea(.T.,"TopConn",TcGenQry(,,cQuery),"SQL2",.T.,.T.) ; DbSelectArea("SQL2")
