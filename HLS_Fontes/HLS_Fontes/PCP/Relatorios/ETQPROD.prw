...
Static Function imprRel()
	...
	Private aColImp			:= {}
	Private oPrinter 		:= FWMSPrinter():New("ETQPROD")
 	Private nLimiteVer		:= oPrinter:nVertRes()//2350//3370
 	Private nLimiteHoz		:= oPrinter:nHorzRes()-010//2350//3370		ja mexi
	Private cAlOP			:= GetNextAlias()
	Private oQrCode
	   
	Private nWidth			:= 100 //200    //altera̤̣o Luciano - 28-03-2019
	Private nHeight			:= 070 //200    //altera̤̣o Luciano - 28-03-2019
	...
	Private oFont24N 		:= TFont():New("Arial", 24, 24,, .T.,,,,, .F., .F.)
   	...
   	DEFINE MSDIALOG oDlg TITLE "Etiquetas Producao" FROM 0,0 TO 200,400 PIXEL // ja mexi
...
Static Function impDados(nPosVert,nLinAtu,nG,nQtdOP,cQtd)
	...
	//box
	nLinAtu += 50												//DISTANCIA ENTRE ETIQUETAS EM ALTURA
	...
	oPrinter:QRCode(nLinAtu+10, nPosVert+500, cCodBar, 110) //add Luciano em 18/11/2019 tamanho do QR CODE (110)
