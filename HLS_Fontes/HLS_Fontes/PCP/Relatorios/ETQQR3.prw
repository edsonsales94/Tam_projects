...
Static Function imprRel()
	...
	Private aColImp			:= {}
	Private oPrinter 		:= FWMSPrinter():New("ETQQR3")
...
//	Local nRest			:=	0
   ...
   // oPrinter:line(nLinAtu+640,nPosVert+800,nLinAtu+640,nPosVert+800)
	...
	oPrinter:say(nLinAtu+005,nPosVert+415,(cAlOP)->B1_DESCHL,oFont12N)
	nLinAtu += 080
	...
	oPrinter:say(nLinAtu+005,nPosVert+415,(cAlOP)->B1_CODMATR,oFont24N)	
	nLinAtu += 080
	...
	oPrinter:QRCode(nLinAtu+10, nPosVert+500, cCodBar, 90)
...
Static Function buscaDados()
	...
	memoWrite("\SQL\ETQQR3.SQL",cQuery)
...
Static Function ValidPerg()
	...
	If ParamBox(aParamBox,"ETQQR3",@aRet,,,,,,,"ETQQR3",.T.,.T.)
		lRet := .t.
	EndIf
