...
User Function UTLFON01()  
    ...
    //Criando a janela
    DEFINE MSDIALOG oDlgForm TITLE "UTLFON01 - Execução de Fórmulas" FROM 000, 000  TO nJanAltu, nJanLarg COLORS 0, 16777215 PIXEL
