...
±±³Fun‡…o    ³ GPER030E ³ Autor ³ R.H. - Ze Maria         ³ Data ³ 14.03.95 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Emissao de Recibos de Pagamento                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Sintaxe   ³ GPER030E(void)                                               ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³                                                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Uso       ³ Especifico p/ Seiren Automotive                              ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Alteracao ³ Paulo R. de Oliveira em 21/06/07                             ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
...
±±³Renata      ³14/06/2007³127688|Ajuste no teste das variaveis de dif.diss.³±±
±±³            ³          ³      |da 1. e 2. Parc. 13.Sal(acodfol[398,1],   ³±±
±±³            ³          ³      |acodfol[400,1])                           ³±±
...
///////////////////////////////////////////////////////////////////////////////////////////////
User Function GPER030E(lTerminal,cFilTerminal,cMatTerminal,cMesAnoRef,nRecTipo,cSemanaTerminal)
///////////////////////////////////////////////////////////////////////////////////////////////
//
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
wnrel:="GPER030E"            //Nome Default do relatorio em Disco
...
Local nContr  := 0
Local nContrT :=0
Private nLinhas:=14              // Numero de Linhas do Miolo do Recibo (16)
Ordem_Rel := 1
If cPaisLoc == "ARG"
	fCabecArg()
Else
...
LI ++
@ LI,00 PSAY &cNormal
@ LI,01 PSAY "Empresa .: " + Substr(DESC_Fil, 1, 40)
LI ++
@ LI,01 PSAY "Endereco : " + Substr(DESC_END, 1, 40)
LI ++
@ LI,01 PSAY "CNPJ ....: " + Transform(DESC_CGC, "@R 99.999.999/9999-99")
If !Empty(Semana) .And. Semana # '99' .And.  Upper(SRA->RA_TIPOPGT) == 'S'
	// @ Li,36 pSay STR0013 + Semana + ' (' + cSem_De + STR0014 + ;	//'Semana '###' a '
	// cSem_Ate + ')'
Else
	// @ LI,36 PSAY MesExtenso(MONTH(dDataRef))+"/"+STR(YEAR(dDataRef),4)
EndIf
LI ++
@ LI,01 PSAY "Funcao ..: " + Substr(cDescFunc, 1, 40)
LI +=3
@ LI,01 PSAY SRA->RA_Mat
@ LI,09 PSAY Left(SRA->RA_NOME,30)
@ LI,41 PSAY fCodCBO(SRA->RA_FILIAL,cCodFunc ,dDataRef)
// @ LI,45 PSAY SRA->RA_Filial
// @ LI,51 PSAY Substr(SRA->RA_CC, 1, 11)
@ LI,57 PSAY Substr(MesExtenso(Month(dDataRef)), 1, 3) + "/" + Str(Year(dDataRef), 4)
@ LI,66 PSAY ORDEM_REL PICTURE "99"
LI ++
...
Local nCol := If(aLanca[nConta,1]="P",43,If(aLanca[nConta,1]="D",56,49))
...
If !lLinhaRoda
	LI += 1
Endif
@ LI,01 PSAY " " // DESC_MSG1
LI ++
@ LI,01 PSAY DESC_MSG1 // 2
@ LI,42 PSAY TOTVENC PICTURE cPict1
@ LI,55 PSAY TOTDESC PICTURE cPict1
LI ++
@ LI,01 PSAY DESC_MSG2 // 3
LI ++
IF MONTH(dDataRef) = MONTH(SRA->RA_NASC)
   @ LI, 01 PSAY Substr(STR0038, 1, 40)		//"F E L I Z   A N I V E R S A R I O  ! !"
Else
   @ LI, 01 PSAY " "
ENDIF
...
If Esc = 1  // Bases de Adiantamento
	If cBaseAux = "S" .And. nBaseIr # 0
		@ LI,60 PSAY nBaseIr PICTURE cPict1
	Endif
ElseIf Esc = 2 .Or. Esc = 4  // Bases de Folha e 13o. 2o.Parc.
	If cBaseAux = "S"
		@ LI,18 PSAY Transform(nAteLim,cPict1)
		If nBaseFgts # 0
			@ LI,33 PSAY nBaseFgts PICTURE cPict1
		Endif
		If nFgts # 0
		...
		If nBaseIr # 	0
			@ LI,60 PSAY nBaseIr PICTURE cPict1
		Endif
		// @ LI,100 PSAY Transform(nBaseIrfE,cPict1)
	Endif
