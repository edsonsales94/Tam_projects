...
user function MT103FIM()
	...
	// Grava dados da corrida by Wladimir vieira 16/04/2019
	...
	¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
	¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*/
    // testa se foi digitado a corrida by wlad
	IF TYPE ("_mAdados") == "U"
		Return
	endif
    ...
    // grava a corrida
	dbSelectArea("SZ9")
	For I:=1 to Len(_mAdados) 
		If Reclock("SZ9",.T.)
			Z9_FILIAL := xFilial("SZ9")
//			Z9_CODCOR := _mAdados[I,2]  //alteração do projeto, deixa de gravar a corrida
			Z9_DOC    := _mAdados[I,3]
			Z9_SERIE  := _mAdados[I,4]
			Z9_ITEMNF := _mAdados[I,5]
			Z9_COD    := _mAdados[I,6]
			Z9_LOTE   := _mAdados[I,7]
			Z9_QUANT  := _mAdados[I,8]
