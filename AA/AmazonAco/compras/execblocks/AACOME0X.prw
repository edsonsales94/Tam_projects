...
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
¦¦¦ Funcao    ¦ AACOME03   ¦ Autor ¦ Wermeson Gadelha     ¦ Data ¦ 22/04/2019 ¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
¦¦¦ Descricao ¦ Rotina para geracao de sugestao de compras                    ¦¦¦
¦¦+-----------+---------------------------------------------------------------+¦¦
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯*/
User Function AACOME0X()
 //-------------------------------------------------------. 
 ...
 Private aCabec     := {} 
    ...
    @ 02,05 TO 045,580 label "Filtros" OF oDlg	 PIXEL
	
	@ 05,010 + 000 Say "Produto: "                               Size 50,10 Pixel Of oUp
	@ 15,010 + 000 MsGet odProdDe      Var _cdProdDe  F3 'SB1'   Size 60,08 Pixel of oUp
	@ 15,070 + 000 MsGet odProdAte     Var _cdProdAte F3 'SB1'   Size 60,08 Pixel of oUp

	@ 05,010 + 160 Say "Ferramenta: "                            Size 50,10 Pixel Of oUp
	@ 15,010 + 160 MsGet odFerraDe      Var _cdFerraDe  F3 'SZH' Size 30,08 Pixel of oUp
	@ 15,040 + 160 MsGet odFerraAte     Var _cdFerraAte F3 'SZH' Size 30,08 Pixel of oUp

	@ 05,010 + 250 Say "Grupo: "                                 Size 50,10 Pixel Of oUp
	@ 15,010 + 250 MsGet odGrupoDe   Var _cdGrupoDe  F3 'SBM'    Size 30,08 Pixel of oUp
	@ 15,040 + 250 MsGet odGrupoAte  Var _cdGrupoAte F3 'SBM'    Size 30,08 Pixel of oUp
                                                                             
	@ 05,010 + 340 Say "Armazem: "                               Size 50,10 Pixel Of oUp
	@ 15,010 + 340 MsGet odLocalDe    Var _cdLocalDe   F3 'AL '  Size 30,08 Pixel of oUp
	@ 15,040 + 340 MsGet odLocalAte   Var _cdLocalAte  F3 'AL '  Size 30,08 Pixel of oUp

	@ 05,010 + 430 Say "Tipos: "                                 Size 50,10 Pixel Of oUp
	@ 15,010 + 430 MsGet odTipoDe    Var _cdTipoDe   F3 '02 '    Size 30,08 Pixel of oUp
	@ 15,040 + 430 MsGet odTipoAte   Var _cdTipoAte  F3 '02 '    Size 30,08 Pixel of oUp

	@ 05,010 + 520 Say "Meses Estoque: "                         Size 50,10 Pixel Of oUp
	@ 15,010 + 520 MsGet odMeses    Var _cdMeses                 Size 30,08 Pixel of oUp
...
//	@ 024,10 Button "&Fechar"    Size 40,12 Pixel of oUp2 Action oDlg:End()
		...
		oBrowse:AddButton("&Detalhes PC", { || u_AACOMEXA(WWW1->B1_COD)},,,, .F., 2 )
 ...
 Local nI     := 0  
	...
	For nI := 01 To 06
		...
		Else
			...
			EndIf 
		EndIf
		awDesc[nI] :=  aMeses[_cdMes] 
	Next nI

   aadd(aFields, Field_("MARK"      ,""                ,"C", {01,00} , "@!") )
   aadd(aFields, Field_("B1_CODNAC" ,"Nacional"        ,"C", {04,00} , "@!") )
   aadd(aFields, Field_("B1_CODIMP" ,"Importado"       ,"C", {04,00} , "@!") )
   aadd(aFields, Field_("B1_ESPECIF","Especificação"   ,"C", {08,00} , "@!") )
   aadd(aFields, Field_("MES01"     ,awDesc[1]         ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("MES02"     ,awDesc[2]         ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("MES03"     ,awDesc[3]         ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("MES04"     ,awDesc[4]         ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("MES05"     ,awDesc[5]         ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("MES06"     ,awDesc[6]         ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("PEDIDO"    ,"Pedido"          ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("B2_QATU"   ,"Saldo"           ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("SUGESTAO"  ,"Sugestão"        ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("TEMPO"     ,"Projeção Estoque","C", {08,00} , "@!") )
   aadd(aFields, Field_("MEDIA"     ,"Media"           ,"N", {05,02} , "@E 999,999,999.99") )
   aadd(aFields, Field_("ORIGINAL"  ,"Original"        ,"N", {05,02} , "@E 999,999,999.99") )

   aLinha := {}
   aCabec := {}
		      
   aAdd(aLinha,"Nacional")
   aAdd(aLinha,"Importado")
   aAdd(aLinha,"Especificacao")      	
   aAdd(aLinha,awDesc[1])     	
   aAdd(aLinha,awDesc[2])
   aAdd(aLinha,awDesc[3])
   aAdd(aLinha,awDesc[4])                                    			  
   aAdd(aLinha,awDesc[5])
   aAdd(aLinha,awDesc[6])
   aAdd(aLinha,"Pedido")
   aAdd(aLinha,"Saldo")
   aAdd(aLinha,"Sugestao")
   aAdd(aLinha,"Projecao")
   aAdd(aLinha,"Media")
...
Static Function GetSql()
    ...
    AAdd(aCampos,{"B1_CODNAC"  ,"C",TamSX3("B1_COD"     )[1], 0})
	AAdd(aCampos,{"B1_CODIMP"  ,"C",TamSX3("B1_COD"     )[1], 0})
    AAdd(aCampos,{"B1_ESPECIF" ,"C",TamSX3("B1_ESPECIF" )[1], 0})
    AAdd(aCampos,{"MES01"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"MES02"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"MES03"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"MES04"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"MES05"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"MES06"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"PEDIDO"     ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"B2_QATU"    ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"SUGESTAO"   ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    AAdd(aCampos,{"TEMPO"      ,"C",030                     , 0})
    AAdd(aCampos,{"MEDIA"      ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
  //  AAdd(aCampos,{"ZH_DESC"    ,"C",TamSX3("ZH_DESC"    )[1], 0})
    AAdd(aCampos,{"ORIGINAL"   ,"N",TamSX3("B2_QATU"    )[1], TamSX3("B2_QATU"    )[2]})
    ...
    IndRegua("WWW1", cIndice2, "B1_ESPECIF",,, "Indice Login...")
   ...
   // Modificado para a procedure para deixar mais rapido
    _cdQry := " Exec AA_SUGESTAOCOMPRAX 
	...
	While !(_cdTbl)->(Eof())
		...
		//	WWW1->ZH_DESC    := (_cdTbl)->ZH_DESC
			WWW1->B1_CODNAC   := (_cdTbl)->COD_NAC
			WWW1->B1_CODIMP   := (_cdTbl)->COD_IMP
			WWW1->B1_ESPECIF := (_cdTbl)->B1_ESPECIF
			WWW1->MES01      := (_cdTbl)->MES01
			WWW1->MES02      := (_cdTbl)->MES02
			WWW1->MES03      := (_cdTbl)->MES03
			WWW1->MES04      := (_cdTbl)->MES04
			WWW1->MES05      := (_cdTbl)->MES05
			WWW1->MES06      := (_cdTbl)->MES06
			WWW1->PEDIDO     := (_cdTbl)->PEDIDO
			WWW1->B2_QATU    := (_cdTbl)->B2_QATU
			WWW1->SUGESTAO   := (_cdTbl)->SUGESTAO
			WWW1->TEMPO      := (_cdTbl)->TEMPO
			WWW1->MEDIA      := (_cdTbl)->MEDIA
			WWW1->ORIGINAL   := (_cdTbl)->SUGESTAO
		MsUnLock()
 ...
 Local lSol  := .F. 
	...
	While !WWW1->(Eof())		
		...
		IF WWW1->SUGESTAO > 0 .AND. !Empty(WWW1->MARK)
			...
			SB1->(dbSetOrder(1))
			SB1->(dbSeek(xFilial("SB1")+WWW1->B1_COD))
