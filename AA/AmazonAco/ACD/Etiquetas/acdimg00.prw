...
±±ºPrograma  ³IMG00     ºAutor  ³Sandro Valex        º Data ³  19/06/01   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³Ponto de entrada referente a imagem de rosto.               º±±
...
//Esta etiqueta IMG00 esta zuando a rotina de divisao de etiquetas 
If paramixb[1] =='T_ACDV210'
	Return .T.
EndIf
...
ElseIf paramixb[1] =='T_ACDI10PD'.OR. paramixb[1] =='T_ACDV125'
	...
	MSCBEND()
ElseIf paramixb[1] =='T_ACDI10NF' // identificacao de produto
	MSCBBEGIN(1,6) //Inicio da Imagem da Etiqueta
	MSCBLineV(01,01,32,300)
