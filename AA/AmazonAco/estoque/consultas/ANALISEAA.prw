...
±±ºPrograma  ³CHECKEST  ºAutor  ³                    º Data ³  19/08/2005 º±±
...
Aadd(aDetSB8   ,{Space(01),Space(10),Space(01),CTOD("  /  /  "),0,0,Space(01),Space(01),Space(01),Space(01)})
Aadd(aDetSD5   ,{CTOD("  /  /  "),Space(01),Space(10),Space(01),Space(01),0,0,Space(06),Space(06),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDetSBF   ,{Space(15),Space(10),0,Space(01),0,Space(01),Space(01),Space(01),0,0,Space(01)})
Aadd(aDetSDB   ,{Space(01),CTOD("  /  /  "),Space(01),Space(15),Space(10),0,0,Space(06),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDet01B8BF,{Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDet02B8BF,{Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDetSBJ   ,{Space(01),Space(01),Space(01),Space(01)})
Aadd(aAnaSBJ   ,{Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDetSBK   ,{Space(01),Space(01),Space(01),Space(01)})
Aadd(aAnaSBK   ,{Space(01),Space(01),Space(01),Space(01)})
Aadd(aDetDASDA ,{Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDetDASB8 ,{Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aDocto    ,{Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
Aadd(aNumSeq   ,{Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01),Space(01)})
AAdd(aKarLocal ,{Space(03),Space(08),Space(03),Space(03),Space(06),Space(01),Space(01),Space(06)})
AAdd(aKarLote  ,{Space(03),Space(08),Space(03),Space(06),Space(06),Space(01),Space(08),Space(01),Space(01),Space(30),Space(01)})
AAdd(aKarEnde  ,{Space(03),Space(08),Space(03),Space(06),Space(15),Space(01),Space(01),Space(01),Space(06),Space(01)})

DEFINE MSDIALOG oDlgMain TITLE "Analise de Saldos"  OF oMainWnd PIXEL FROM 040,040 TO 730,1000
DEFINE FONT oBold   NAME "Arial" SIZE 0, -12 BOLD
DEFINE FONT oBold2  NAME "Arial" SIZE 0, -40 BOLD

DBSelectArea("SB1")

@ 060,006 FOLDER oFolder OF oDlgMain PROMPT "&Saldo","SB8xSD5","SBFxSDB","SB8xSBF","SBJxSBK","SBJ","SBK","SDAxSB2xSB8","Kardex Local","Kardex Lote","Kardex Endereco","Documento","NumSeq" PIXEL SIZE 470,280
...
/*
@ 022,315 LISTBOX oBox Var cFolder FIELDS HEADER " ",OemToAnsi("Folder") SIZE 090,120 ON DBLCLICK (TrocaTip()) PIXEL OF oFolder:aDialogs[1] 
oBox:nFreeze := 1
oBox:SetArray(aFolder)
oBox:bLine:={ ||{IIF(aFolder[oBox:nAT,1],oMarked,oNoMarked),aFolder[oBox:nAT,2]}}

@ 030,410 BUTTON OemtoAnsi("Marcar Todos")    SIZE 50,12 ACTION MarcaTodos(.T.) PIXEL OF oFolder:aDialogs[1]
@ 050,410 BUTTON OemtoAnsi("Desmarcar Todos") SIZE 50,12 ACTION MarcaTodos(.F.) PIXEL OF oFolder:aDialogs[1]
*/
@ 180,115 BUTTON OemtoAnsi("Alterar SB9") SIZE 50,12 ACTION fAjustSB9("SALDO_SB9") PIXEL OF oFolder:aDialogs[1] WHEN lEdit
@ 180,180 BUTTON OemtoAnsi("Alterar SB2") SIZE 50,12 ACTION fAjustSB2("SALDO_SB2") PIXEL OF oFolder:aDialogs[1] WHEN lEdit
...
@ 001,075 BUTTON "Incluir"         SIZE 30,10 ACTION (fAjustSB8("B8_I"))                           PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 001,120 BUTTON "Alterar"         SIZE 30,10 ACTION (fAjustSB8("B8_A"))                           PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 001,165 BUTTON "Excluir"         SIZE 30,10 ACTION (fAjustSB8("B8_E"))                           PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 001,205 BUTTON "Aglut. SubLote"  SIZE 40,10 ACTION (Processa({||fAjSLote()}))  			       PIXEL OF oFolder:aDialogs[2] When lEdit
@ 001,260 BUTTON "Bal. D5/B8"      SIZE 40,10 ACTION (Processa({||fAjD5Lote()}))  			       PIXEL OF oFolder:aDialogs[2] When lEdit
@ 001,320 BUTTON "Lote e NumLote"  SIZE 40,10 ACTION (nOpSB8:= 1,Processa({||fDetaSB8()}))         PIXEL OF oFolder:aDialogs[2] When IF(nOpSB8=2,.T.,.F.)
...
@ 010,005 LISTBOX oDetSB8 Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Validade"),;
	OemToAnsi("Saldo"),;
	OemToAnsi("Qtde.Original"),; 
	OemToAnsi("Status"),;
	OemToAnsi("Empenho"),;			
	OemToAnsi("Qtde.2UM"),;	
	OemToAnsi("Empenho 2UM") SIZE 457,110 ON DBLCLICK () PIXEL OF oFolder:aDialogs[2]
...
@ 121,075 BUTTON "Incluir D5"       SIZE 30,10 ACTION (fAjustSD5("D5_I","02"))                      PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 121,120 BUTTON "Alterar D5"       SIZE 30,10 ACTION (fAjustSD5("D5_A","02"))                      PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 121,165 BUTTON "Excluir D5"       SIZE 30,10 ACTION (fAjustSD5("D5_E","02"))                      PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 121,210 BUTTON "Incluir D5+B8"    SIZE 40,10 ACTION (fAjustSD5("D5+B8_I","02"))                   PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 121,265 BUTTON "Subtrair D5+B8"   SIZE 40,10 ACTION (fAjustSD5("D5+B8_S","02"))                   PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
@ 121,320 BUTTON "Estornar D5+B8"   SIZE 40,10 ACTION (fAjustSD5("D5+B8_E","02"))                   PIXEL OF oFolder:aDialogs[2] When lEdit .and. IF(nOpSB8=1,.T.,.F.)
...
@ 130,005 LISTBOX oDetSD5 Var cDetSD5 FIELDS HEADER; 
    ...
    OemToAnsi("Serie"),;
    OemToAnsi("Clie.For"),;
    OemToAnsi("Loja")  SIZE 457,130 ON DBLCLICK () PIXEL OF oFolder:aDialogs[2]
...
@ 001,075 BUTTON "Incluir"         SIZE 30,10 ACTION (fAjustSBF("BF_I"))                           PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 001,120 BUTTON "Alterar"         SIZE 30,10 ACTION (fAjustSBF("BF_A"))                           PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 001,165 BUTTON "Excluir"         SIZE 30,10 ACTION (fAjustSBF("BF_E"))                           PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 001,210 BUTTON "Bal. DB/BF"      SIZE 40,10 ACTION (Processa({||fAjDBLote()}))                   PIXEL OF oFolder:aDialogs[3] When lEdit 
...
@ 010,005 LISTBOX oDetSBF Var cModelo FIELDS HEADER; 
    OemToAnsi("Localização"),;
	OemToAnsi("Lote"),;
	OemToAnsi("Quantidade"),;
	OemToAnsi("Status"),;
	OemToAnsi("Empenho"),;			
	OemToAnsi("Estrutura"),;
	OemToAnsi("Status End"),;
	OemToAnsi("Zona"),;
	OemToAnsi("Qtde.2UM"),;	
	OemToAnsi("Empenho 2UM") SIZE 457,110 ON DBLCLICK () PIXEL OF oFolder:aDialogs[3]
...
@ 121,075 BUTTON "Incluir DB"       SIZE 30,10 ACTION (fAjustSDB("DB_I","03"))                      PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 121,120 BUTTON "Alterar DB"       SIZE 30,10 ACTION (fAjustSDB("DB_A","03"))                      PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 121,165 BUTTON "Excluir DB"       SIZE 30,10 ACTION (fAjustSDB("DB_E","03"))                      PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 121,210 BUTTON "Incluir DB+BF"    SIZE 40,10 ACTION (fAjustSDB("DB+BF_I","03"))                   PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 121,265 BUTTON "Subtrair DB+BF"   SIZE 40,10 ACTION (fAjustSDB("DB+BF_S","03"))                   PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
@ 121,320 BUTTON "Estornar DB+BF"   SIZE 40,10 ACTION (fAjustSDB("DB+BF_E","03"))                   PIXEL OF oFolder:aDialogs[3] When lEdit .and. IF(nOpSBF=1,.T.,.F.)
...
@ 130,005 LISTBOX oDetSDB Var cDetSDB FIELDS HEADER; 
    ...
    OemToAnsi("Serie"),;
    OemToAnsi("Clie.For"),;
    OemToAnsi("Loja") SIZE 457,130 ON DBLCLICK () PIXEL OF oFolder:aDialogs[3]
...
@ 010,005 LISTBOX oDet01B8BF Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Qtde."),;
	OemToAnsi("Empenho"),;
	OemToAnsi("A Classificar"),;
	OemToAnsi("Qtde.2UM"),;
	OemToAnsi("Empenho 2UM"),;
	OemToAnsi("A Classificar 2UM"),;
	OemToAnsi("Status") SIZE 457,110 ON DBLCLICK () PIXEL OF oFolder:aDialogs[4]
...
@ 130,005 LISTBOX oDet02B8BF Var cDet02B8BF FIELDS HEADER; 
	...
	OemToAnsi("Qtde.2UM"),;
	OemToAnsi("Empenho 2UM"),;
    OemToAnsi("Status") SIZE 457,130 ON DBLCLICK () PIXEL OF oFolder:aDialogs[4]
...
@ 010,005 LISTBOX oDetSBJ Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Qtde."),;
	OemToAnsi("Qtde.2UM"),;
	OemToAnsi("Status") SIZE 457,110 ON DBLCLICK () PIXEL OF oFolder:aDialogs[5]
...
@ 130,005 LISTBOX oDetSBK Var cDet02B8BK FIELDS HEADER; 
	...
	OemToAnsi("Qtde."),;
	OemToAnsi("Qtde.2UM"),;
	OemToAnsi("Status") SIZE 457,130 ON DBLCLICK () PIXEL OF oFolder:aDialogs[5]
...
@ 001,210 BUTTON "Incluir"         SIZE 30,10 ACTION (fAjustSBJ("BJ_I"))        PIXEL OF oFolder:aDialogs[6] When lEdit
@ 001,265 BUTTON "Alterar"         SIZE 30,10 ACTION (fAjustSBJ("BJ_A"))        PIXEL OF oFolder:aDialogs[6] When lEdit
@ 001,320 BUTTON "Excluir"         SIZE 30,10 ACTION (fAjustSBJ("BJ_E"))        PIXEL OF oFolder:aDialogs[6] When lEdit
...
@ 010,005 LISTBOX oAnaSBJ Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Nunlote"),;
	OemToAnsi("Validade"),;
	OemToAnsi("Quantidade") SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[6]
...
@ 001,210 BUTTON "Incluir"         SIZE 30,10 ACTION (fAjustSBK("BK_I"))        PIXEL OF oFolder:aDialogs[7] When lEdit
@ 001,265 BUTTON "Alterar"         SIZE 30,10 ACTION (fAjustSBK("BK_A"))        PIXEL OF oFolder:aDialogs[7] When lEdit
@ 001,320 BUTTON "Excluir"         SIZE 30,10 ACTION (fAjustSBK("BK_E"))        PIXEL OF oFolder:aDialogs[7] When lEdit
...
@ 010,005 LISTBOX oAnaSBK Var cDet02B8BK FIELDS HEADER; 
    OemToAnsi("Endereco"),;
    OemToAnsi("Lote"),;
	OemToAnsi("Quantidade") SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[7]
...
@ 003,100 SAY "Saldo SB2 : "+Trans(nDASB2,cPict)   SIZE 200,50                                    PIXEL OF oFolder:aDialogs[8] FONT oBold
@ 001,250 BUTTON "Alterar Saldo A Classificar SB2" SIZE 80,10 ACTION (fAjustSB2("CLASS_SB2"))     PIXEL OF oFolder:aDialogs[8] When lEdit
...
@ 010,005 LISTBOX oDetDASDA Var cModelo FIELDS HEADER; 
    ...
    OemToAnsi("Clie.For"),;
    OemToAnsi("Loja"),; 
    OemToAnsi("Status") SIZE 457,110 ON DBLCLICK () PIXEL OF oFolder:aDialogs[8]
...
@ 121,420 BUTTON "Alterar"     SIZE 30,10 ACTION (fAjustSDA("DAxB8"))   PIXEL OF oFolder:aDialogs[8] When lEdit
@ 130,005 LISTBOX oDetDASB8 Var cDet02B8BK FIELDS HEADER; 
    ...
    OemToAnsi("Clie.For"),;
    OemToAnsi("Loja"),; 
    OemToAnsi("Status") SIZE 457,130 ON DBLCLICK () PIXEL OF oFolder:aDialogs[8]
...
@ 010,005 LISTBOX oKarLocal Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Quantidade"),;	
	OemToAnsi("Saldo"),;   
	OemToAnsi("Sequencia") 	SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[9]
...
@ 001,420 BUTTON "Processar"                            SIZE 30,10 ACTION (Processa({||fDetaSB8(),fKardLote()}))  PIXEL OF oFolder:aDialogs[10]
@ 010,005 LISTBOX oKarLote Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Quantidade"),;   			
	OemToAnsi("Saldo"),;   
	OemToAnsi("Sequencia") 	SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[10]
...
@ 001,420 BUTTON "Processar"                            SIZE 30,10 ACTION (Processa({||fDetaSBF(),fKardEnde()}))  PIXEL OF oFolder:aDialogs[11]
@ 010,005 LISTBOX oKarEnde Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Quantidade"),;   			
	OemToAnsi("Saldo"),;   
	OemToAnsi("Sequencia") 	SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[11]
...
@ 010,005 LISTBOX oDocto Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Status"),;  
	OemToAnsi("Serviço"),;
	OemToAnsi("Status Serviço"),;
    OemToAnsi("Serviço Pendente") SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[12]
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// NumSeq
@ 001,040 BUTTON "Somente Movimento Com Diferença"     SIZE 100,10 ACTION (Processa({||fSoNumSeq()})) PIXEL OF oFolder:aDialogs[13]
@ 001,180 BUTTON "Incluir SD5"     SIZE 30,10 ACTION (fAjustSD5("D5_I","13"))                         PIXEL OF oFolder:aDialogs[13] When lEdit
@ 001,240 BUTTON "Incluir SDB"     SIZE 30,10 ACTION (fAjustSDB("DB_I","13"))                         PIXEL OF oFolder:aDialogs[13] When lEdit
@ 001,300 BUTTON "Alterar"         SIZE 30,10 ACTION (fAjustD5DB("D5DB_A"))                           PIXEL OF oFolder:aDialogs[13] When lEdit
@ 001,375 BUTTON "Processar"       SIZE 30,10 ACTION (Processa({||fNumSeq(),fDetaSDA()}))             PIXEL OF oFolder:aDialogs[13]
@ 001,420 BUTTON "Pesquisar"       SIZE 30,10 ACTION (fPesquisa("NUMSEQ",oNumSeq))                    PIXEL OF oFolder:aDialogs[13]
@ 010,005 LISTBOX oNumSeq Var cModelo FIELDS HEADER; 
	...
	OemToAnsi("Serviço"),;
	OemToAnsi("Status Serviço"),;
    OemToAnsi("Serviço Pendente") SIZE 457,250 ON DBLCLICK () PIXEL OF oFolder:aDialogs[13]
...
TCQUERY cQuery ALIAS "QrySBJ" NEW
nSBJ := QrySBJ->BJ_QINI
DBCloseArea()
...
TCQUERY cQuery ALIAS "QrySBK" NEW
nSBK := QrySBK->BK_QINI
DBCloseArea()
...
TCQUERY cQuery ALIAS "QrySB8" NEW
...
TCQUERY cQuery ALIAS "QrySBF" NEW
...
TCQUERY cQuery ALIAS "QrySDA" NEW
...
TCQUERY cQuery ALIAS "QrySB9" NEW
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fAjSLote()
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Local aNumLote := {}

If nSB2 == nSB8 .and. nSB2 == nSBF
	msgInfo("Item já esta balanceado!")
	If !msgyesno("Deseja continuar ?")
		Return
	Endif	
Endif
/*/
	For x := 1 to Len(aNumTmpEtiq)
...
/*/       
nX := 1
Do While nX <= Len(aDetSB8)
	//
	aNumLote  := {}
	_cLotectl := aDetSB8[nX][2]
	_cNumLote := aDetSB8[nX][3]
	//
	IncProc("Aglutinando sublotes para o lote ..."+aDetSB8[nX][2])		
	Do While nX <= Len(aDetSB8) .and. _cLotectl == aDetSB8[nX][2]
	   aadd(aNumLote, aDetSB8[nX][3])
       nX++
	Enddo	
	//
	_cListNum := ""
	For nY := 2 to Len(aNumLote)
		_cListNum += aNumLote[nY] + iif(nY<>Len(aNumLote),",","")
	Next
	_cListNum := fContidoSQL(_cListNum)				    
	msginfo(_cListNum)
	//
	If Len(aNumLote) > 1
		//
		cQuery  :=	"UPDATE "+ RetSqlName("SD5") +" SET D5_NUMLOTE = '" +_cNumLote+ "' "
		cQuery  +=  " WHERE D_E_L_E_T_ <> '*' "
		cQuery  +=  " AND D5_FILIAL   = '" + xFilial("SD5") + "' "		
		cQuery  +=  " AND D5_LOCAL    = '" + cLocal         + "' "		
		cQuery  +=  " AND D5_PRODUTO  = '" + cProduto       + "' "
		cQuery  +=  " AND D5_LOTECTL  = '" + _cLotectl      + "' "				
		cQuery  +=  " AND D5_NUMLOTE IN (" + _cListNum      + ") "						
		//
		//If MSGYESNO(cQuery)
		   TcSqlExec(cQuery)
		//Endif
...
Do While nX <= Len(aDetSB8)
	//
	_cData := StrZero(Day(aDetSB8[nX][1]),2)+ StrZero(Month(aDetSB8[nX][1]),2)+ Right(StrZero(Year(aDetSB8[nX][1]),4),2)
	//
	RecLock("SD5", .T.)	
	SD5->D5_FILIAL  := xFilial("SD5")
	SD5->D5_PRODUTO := cProduto
	SD5->D5_LOCAL   := cLocal   
	SD5->D5_DOC     := "A"+cLocal+_cData
	SD5->D5_DATA    := aDetSB8[nX][1]
	SD5->D5_ORIGLAN := iif(aDetSB8[nX][5]>0,"999","499")
	SD5->D5_QUANT   := ABS(aDetSB8[nX][5])
	SD5->D5_LOTECTL := aDetSB8[nX][2]		
	SD5->D5_NUMLOTE := aDetSB8[nX][3]			
	SD5->D5_DTVALID := aDetSB8[nX][4]			
	SD5->(MsUnlock())
	//
	IncProc("Processando lote ... " + aDetSB8[nX][2])
	//
	nX++
Enddo
//oDetSB8:Refresh()
//oDetSD5:Refresh()
MSGINFO("Ajuste finalizado no SD5!")
Return

//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Static Function fAjDBLote()
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Do While nX <= Len(aDetSBF)
	...
	SDB->DB_LOCAL   := cLocal   
	SDB->DB_LOCALIZ := aDetSBF[nX][1]
	SDB->DB_DOC     := "A"+cLocal+_cData
	SDB->DB_TM      := iif(aDetSBF[nX][3]>0,"999","499")
	SDB->DB_ORIGEM  := "SD3"
	SDB->DB_QUANT   := ABS(aDetSBF[nX][3])
	SDB->DB_DATA    := aDetSB8[nX][1]
	SDB->DB_LOTECTL := aDetSBF[nX][2]		
	SDB->DB_ATUEST  := "S"
	SDB->(MsUnlock())
	//
	IncProc("Processando lote ..." + aDetSBF[nX][2])
	//
	nX++
Enddo
//oDetSB8:Refresh()
//oDetSD5:Refresh()      
MSGINFO("Ajuste finalizado no SDB!")
Return
...
Else // Lote e NumLote
   ...
   cQuery += " AND D5_ESTORNO= '' AND D5_DATA <= '"+DTOS(dDataF)+"'"
Endif
TCQUERY cQuery ALIAS "QrySD5" NEW
   ...
   For I:= 1 To Len(aDetSB8)  
     ...
     For J:= 1 To Len(aDetSD5)
       IF aDetSB8[I,2]+aDetSB8[I,3] == aDetSD5[J,3]+aDetSD5[J,4]
          nSaldo += IF(aDetSD5[J,2] <= "500" .OR. Substr(aDetSD5[J,2],1,2) $ 'DE/PR/MA',aDetSD5[J,6],aDetSD5[J,6]*-1)
          aDetSD5[J,07] := nSaldo      
          aDetSD5[J,09] := "OK"
       Endif   
     Next
...
Enddo
DBCloseArea()
IF nOpSB8 == 1 // Lote e NumLote
   aSort(aDetSD5,,, { |x,y| y[8]+y[2] > x[8]+y[2]} )      
Endif   
nSaldo := 0
For I:= 1 To Len(aDetSD5)
   IF !Empty(aDetSD5[I,1])
      nSaldo += IF(aDetSD5[I,2] <= "500" .OR. Substr(aDetSD5[I,2],1,2) $ 'DE/PR/MA',aDetSD5[I,6],aDetSD5[I,6]*-1)
      aDetSD5[I,07] := nSaldo     
      aDetSD5[I,09] := "OK"
   Else
      nSaldo := 0
...
TCQUERY cQuery ALIAS "QrySDB" NEW
...
IF Len(aDetSBF) == 0
   ...
   For J:= 1 To Len(aDetSDB)
     IF aDetSDB[oDetSDB:nAT][4]+aDetSDB[oDetSDB:nAT][5] == aDetSDB[J,4]+aDetSDB[J,5]
        nSaldo += IF(aDetSDB[J,3] <= "500" .OR. Substr(aDetSDB[J,3],1,2) $ 'DE/PR/MA',aDetSDB[J,6],aDetSDB[J,6]*-1)
        aDetSDB[J,7] := nSaldo
        aDetSDB[J,9] := "OK"
     Endif   
   Next
...
For I:= 1 To Len(aDetSDB)
   IF !Empty(aDetSDB[I,1])
      nSaldo += IF(aDetSDB[I,3] <= "500" .OR. Substr(aDetSDB[I,3],1,2) $ 'DE/PR/MA',aDetSDB[I,6],aDetSDB[I,6]*-1)
      aDetSDB[I,7] := nSaldo
   Else
      nSaldo := 0
   Endif   
...
cQuery += " WHERE BJ_FILIAL='"+xFilial("SBJ")+"' AND BJ_LOCAL='"+cLocal+"' AND "+RETSQLNAME("SBJ")+".D_E_L_E_T_ <> '*' AND BJ_COD = '"+cProduto+"'"
cQuery += " AND BJ_DATA = '"+DTOS(dUltFech)+"' AND BJ_QINI<>0 ORDER BY BJ_LOTECTL,BJ_NUMLOTE"
TCQUERY cQuery ALIAS "QrySBJ" NEW
...
cQuery := " SELECT DA_DATA,DA_QTDORI,DA_SALDO,DA_LOTECTL,DA_NUMSEQ,DA_ORIGEM,DA_DOC,DA_SERIE,DA_CLIFOR,DA_LOJA FROM "+RETSQLNAME("SDA")
...
While !Eof() 
  AAdd(aDetDASDA,{DA_DATA,DA_LOTECTL,DA_SALDO,0,DA_QTDORI,DA_NUMSEQ,DA_ORIGEM,DA_DOC,DA_SERIE,DA_CLIFOR,DA_LOJA,"OK"})
...
For I:= 1 To Len(aDetDASB8)
  nPos := Ascan(aDetDASDA,{ |x| x[8]+x[9]+x[10]+x[11]+x[2] == aDetDASB8[I,7]+aDetDASB8[I,8]+aDetDASB8[I,9]+aDetDASB8[I,10]+aDetDASB8[I,2] })
  IF nPos == 0 .OR. aDetDASB8[I,4] <> aDetDASDA[nPos,3]
...
For I:= 1 To Len(aDetDASDA)
  nPos := Ascan(aDetDASB8,{ |x| x[7]+x[8]+x[9]+x[10]+x[2] == aDetDASDA[I,8]+aDetDASDA[I,9]+aDetDASDA[I,10]+aDetDASDA[I,11]+aDetDASDA[I,2] })
  IF nPos == 0 .OR. aDetDASDA[I,3] <> aDetDASB8[nPos,4]
...
// Movimento do SD1
cQuery := " SELECT D1_DTDIGIT,D1_TES,D1_CF,D1_DOC,D1_QUANT,D1_NUMSEQ FROM "+RETSQLNAME("SD1")
cQuery += " INNER JOIN "+RETSQLNAME("SF4")+" ON ( "+IF(Empty(xFilial("SF4")),"D1_TES=F4_CODIGO","D1_FILIAL=F4_FILIAL AND D1_TES=F4_CODIGO")+" AND F4_ESTOQUE = 'S' AND "+RETSQLNAME("SF4")+".D_E_L_E_T_ <> '*')"
...
// Movimento do SD2
cQuery := " SELECT D2_EMISSAO,D2_TES,D2_CF,D2_DOC,D2_QUANT,D2_NUMSEQ FROM "+RETSQLNAME("SD2")
cQuery += " INNER JOIN "+RETSQLNAME("SF4")+" ON ( "+IF(Empty(xFilial("SF4")),"D2_TES=F4_CODIGO","D2_FILIAL=F4_FILIAL AND D2_TES=F4_CODIGO")+" AND F4_ESTOQUE = 'S' AND "+RETSQLNAME("SF4")+".D_E_L_E_T_ <> '*')"
...
TCQUERY cQuery ALIAS "QrySD2" NEW     
...
TCQUERY cQuery ALIAS "QrySD3" NEW     
...
TCQUERY cQuery ALIAS "QryTRB" NEW
While !Eof()
  // Movimento do SBJ
...
For I:= 1 To Len(aKarLote)   
  Do Case
    ...
    Case aKarLote[I,1] == "SALDO"
       ...
       Endif   
       IF nSaldo <> nSalSB8
          aKarLote[I,10] := "Saldo SB8: "+Trans(nSalSB8,cPict)+"  Diferença: "+Trans(ABS(nSalSB8-nSaldo),cPict)
...
For I:= 1 To Len(aKarEnde)   
  Do Case
    ...
    Case aKarEnde[I,1] == "SALDO"
       ...
       Endif   
       IF nSaldo <> nSalSBF
          aKarEnde[I,9] := "Saldo SBF: "+Trans(nSalSBF,cPict)+"  Diferença: "+Trans(ABS(nSalSBF-nSaldo),cPict)
...
// SD1
cQuery := " SELECT D1_DOC AS DOC,D1_SERIE AS SERIE, D1_FORNECE AS CLIEFOR, D1_LOJA AS LOJA,D1_SERVIC AS SERVIC,D1_STSERV AS STSERV,SUM(D1_QUANT) AS QUANT FROM "+RETSQLNAME("SD1")
cQuery += " INNER JOIN "+RETSQLNAME("SF4")+" ON ( "+IF(Empty(xFilial("SF4")),"D1_TES=F4_CODIGO","D1_FILIAL=F4_FILIAL AND D1_TES=F4_CODIGO")+" AND F4_ESTOQUE = 'S' AND "+RETSQLNAME("SF4")+".D_E_L_E_T_ <> '*')"
cQuery += " WHERE D1_FILIAL='"+xFilial("SD1")+"' AND D1_LOCAL='"+cLocal+"' AND "+RETSQLNAME("SD1")+".D_E_L_E_T_ <> '*' AND D1_COD = '"+cProduto+"'"
cQuery += " AND D1_ORIGLAN <> 'LF' AND D1_DTDIGIT >= '"+DTOS(dDataI)+"' AND D1_DTDIGIT <= '"+DTOS(dDataF)+"'"
...
// SD2
cQuery := " SELECT D2_DOC AS DOC,D2_SERIE AS SERIE, D2_CLIENTE AS CLIEFOR, D2_LOJA AS LOJA,SUM(D2_QUANT) AS QUANT FROM "+RETSQLNAME("SD2")
cQuery += " INNER JOIN "+RETSQLNAME("SF4")+" ON ( "+IF(Empty(xFilial("SF4")),"D2_TES=F4_CODIGO","D2_FILIAL=F4_FILIAL AND D2_TES=F4_CODIGO")+" AND F4_ESTOQUE = 'S' AND "+RETSQLNAME("SF4")+".D_E_L_E_T_ <> '*')"
cQuery += " WHERE D2_FILIAL='"+xFilial("SD2")+"' AND D2_LOCAL='"+cLocal+"' AND "+RETSQLNAME("SD2")+".D_E_L_E_T_ <> '*' AND D2_COD = '"+cProduto+"'"
cQuery += " AND D2_ORIGLAN <> 'LF' AND D2_EMISSAO >= '"+DTOS(dDataI)+"' AND D2_EMISSAO <= '"+DTOS(dDataF)+"'"
...
// SD1
cQuery := " SELECT D1_NUMSEQ AS NUMSEQ,D1_DOC,D1_SERIE,D1_FORNECE,D1_LOJA,D1_DTDIGIT,D1_SERVIC AS SERVIC,D1_STSERV AS STSERV,SUM(D1_QUANT) AS QUANT FROM "+RETSQLNAME("SD1")
cQuery += " INNER JOIN "+RETSQLNAME("SF4")+" ON ( "+IF(Empty(xFilial("SF4")),"D1_TES=F4_CODIGO","D1_FILIAL=F4_FILIAL AND D1_TES=F4_CODIGO")+" AND F4_ESTOQUE = 'S' AND "+RETSQLNAME("SF4")+".D_E_L_E_T_ <> '*')"
cQuery += " WHERE D1_FILIAL='"+xFilial("SD1")+"' AND D1_LOCAL='"+cLocal+"' AND "+RETSQLNAME("SD1")+".D_E_L_E_T_ <> '*' AND D1_COD = '"+cProduto+"'"
cQuery += " AND D1_ORIGLAN <> 'LF' AND D1_DTDIGIT >= '"+DTOS(dDataI)+"' AND D1_DTDIGIT <= '"+DTOS(dDataF)+"'"
...
// SD2
cQuery := " SELECT D2_NUMSEQ AS NUMSEQ,D2_DOC,D2_SERIE,D2_CLIENTE,D2_LOJA,D2_EMISSAO,SUM(D2_QUANT) AS QUANT FROM "+RETSQLNAME("SD2")
cQuery += " INNER JOIN "+RETSQLNAME("SF4")+" ON ( "+IF(Empty(xFilial("SF4")),"D2_TES=F4_CODIGO","D2_FILIAL=F4_FILIAL AND D2_TES=F4_CODIGO")+" AND F4_ESTOQUE = 'S' AND "+RETSQLNAME("SF4")+".D_E_L_E_T_ <> '*')"
cQuery += " WHERE D2_FILIAL='"+xFilial("SD2")+"' AND D2_LOCAL='"+cLocal+"' AND "+RETSQLNAME("SD2")+".D_E_L_E_T_ <> '*' AND D2_COD = '"+cProduto+"'"
cQuery += " AND D2_ORIGLAN <> 'LF' AND D2_EMISSAO >= '"+DTOS(dDataI)+"' AND D2_EMISSAO <= '"+DTOS(dDataF)+"'"
...
@ 009,005 SAY "NumSeq"                                  SIZE 040,10 PIXEL OF oDlgSB8 FONT oBold 
...
//   cSerie   := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][11],dDataBase)
//   cCliFor  := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][12],dDataBase)
//   cLoja    := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][13],dDataBase)
   cSerie   := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][11],"")
   cCliFor  := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][12],"")
   cLoja    := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][13],"")
   ...
   dDtValid := IF(Len(aDetSD5)>0,aDetSD5[oDetSD5:nAT][04],CTOD("  /  /  "))
ElseIF cFolder = "13"                  
...
@ 099,005 SAY "NumSeq"                                  SIZE 040,10 PIXEL OF oDlgSD5 FONT oBold 
@ 095,043 MSGET oVar   VAR cNumSeq  Picture "@!"        SIZE 040,10 PIXEL OF oDlgSD5 When lVisNumSeq
@ 114,005 SAY "NumLote"                                 SIZE 040,10 PIXEL OF oDlgSD5 FONT oBold 
...
@ 099,005 SAY "NumSeq"                                  SIZE 040,10 PIXEL OF oDlgSDB FONT oBold 
...
Local cDoc     := IF(Len(aDetDASB8)>0,aDetDASB8[oDetDASB8:nAT][07],0)
...
@ 024,005 SAY "NumLote"                                 SIZE 040,10 PIXEL OF oDlgSBJ FONT oBold 
        ...
        Do Case
           Case aCols[I,1] = "SD1"
             ...
             IF aCols[I,15] // Deletar
                ...
                MsUnlock()
             Else  
                IF aCols[I,02] <> D1_DTDIGIT .OR.;
                   aCols[I,03] <> D1_DOC     .OR.;
                   aCols[I,04] <> D1_SERIE   .OR.;
                   aCols[I,05] <> D1_FORNECE .OR.;
                   aCols[I,06] <> D1_LOJA    .OR.;
                   aCols[I,09] <> D1_LOTECTL .OR.;
                   aCols[I,10] <> D1_NUMLOTE .OR.;
                   aCols[I,11] <> D1_LOCALIZ .OR.;
                   aCols[I,12] <> D1_QUANT   .OR.;
                   aCols[I,13] <> D1_QTSEGUM
                   RecLock("SD1",.F.)
                   ...
                   SD1->D1_NUMLOTE := aCols[I,10]
                   SD1->D1_LOCALIZ := aCols[I,11]
...
aadd(aHeader, {"Origem"           , "ORIGEM"  , "@!"              , 03       , 0         ,"U_xValidACols()"       , ""      , "C"    , ""        ,,})
...
aadd(aHeader, {"TES"              , "TES"     , "@!"              , 03       , 0         ,"U_xValidACols()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"CF"               , "CF"      , "@!"              , 03       , 0         ,"U_xValidACols()"       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Lote"             , "LOTE"    , "@!"              , 10       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"NumLote"          , "NUMLOTE" , "@!"              , 06       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Endereço"         , "ENDERECO", "@!"              , 15       , 0         ,""       , ""      , "C"    , ""        ,,})
aadd(aHeader, {"Qtde."            , "QTDE"    , cPict             , 18       , 2         ,"U_xValidACols()"       , ""      , "N"    , ""        ,,})
aadd(aHeader, {"Qtde.UM2"         , "QTDE2UM" , cPict2UM          , 18       , 2         ,"U_xValidACols()"       , ""      , "N"    , ""        ,,})
