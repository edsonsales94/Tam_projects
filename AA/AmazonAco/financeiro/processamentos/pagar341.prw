    ...
    Case _cTipo == "PT001"	                           
         ...
         If SEA->EA_MODELO == "16"    
           ...
           EndIf
            ...
            _cRetorno += GravaData(SE2->E2_XCOMPET,.F.,5) 
            ...
            _cRetorno += GravaData(SE2->E2_DATAAGE,.F.,5)                            
            ...
            If !Empty(SE2->E2_XCNPJC)
               _cRetorno += Subs(SE2->E2_XCONTRI,1,30)
            Else
         ...
         ElseIf (SEA->EA_MODELO == "17")   
            ...
            _cRetorno += STRZERO(MONTH(SE2->E2_XCOMPET),2)+STRZERO(YEAR(SE2->E2_XCOMPET),4)
            
            // Posicao 030 a 043: N Identificacao  //--- CNPJ/CPF do Contribuinte        
            If !Empty(SE2->E2_XCONTRI)
                _cRetorno += Strzero(Val(SE2->E2_XCNPJC),14)
           Else
           ...
           EndIf
            ...
            _cRetorno += Strzero((SE2->E2_SALDO-SE2->E2_XOUTENT)*100,14)                               
            
            // Posicao 058 a 071: Valor Outras Entidades
            _cRetorno += Strzero(SE2->E2_XOUTENT*100,14)            
            
            // Posicao 072 a 085: Multa        
            _cRetorno += Strzero(SE2->E2_XMULTA+SE2->E2_XJUROS*100,14)            
         ...
         ElseIf SEA->EA_MODELO == "35" 
           ...
           // _cRetorno := "11"                          
            ...
            If !Empty(SE2->E2_XCNPJC)
                _cRetorno += Iif (len(alltrim(SE2->E2_XCNPJC))>11,"1","2")
            Else               
              _cRetorno += "1"       
            EndIf
            ...
            _cRetorno += PADR(SE2->E2_LINDIG,48) 
...
//---- ESTA FUNCAO ESTÁ COMPILADA NO FONTE PAGAR356 - SE NÂO UTILIZAR PAGAR356 - TIRAR O COMENTARIO DESTA FUNCAO
