...
User Function PRODAA()	
Return

WSRESTFUL PROD1 DESCRIPTION "Servico para listar PRODUTOS AA"

WSMETHOD GET DESCRIPTION "Listar PRODUTOS X TABELA DE PRECO por usuario" WSSYNTAX "/PROD1/{usuario}" 
END WSRESTFUL

WSMETHOD GET WSSERVICE PROD1
    ...
    cQry := " SELECT SB1.B1_COD, B1_DESC, SB1.B1_TS, SB1.B1_LOCPAD, SB1.B1_UM, B2_QATU "
