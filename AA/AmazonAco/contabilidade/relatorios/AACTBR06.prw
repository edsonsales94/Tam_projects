#include 'protheus.ch'
#include 'parmtype.ch'
User Function AACTBR06()

Local _aCab     := {}
Local _cdTitulo := "Diferença Entre Contabilidade e Financeiro(BAIXAS)"
Local _cdFile   := ""
...
Local aSay   := {}
Local aButton:= {}
Local _cPerg := PADR('AACTBR06',Len(SX1->X1_GRUPO))
...
_cQry += Chr(13) + Chr(10) + "         CT2_VALOR-E5_VALOR DIFERENCA,
_cQry += Chr(13) + Chr(10) + "         CT2_VALOR,
_cQry += Chr(13) + Chr(10) + "  	    E5_TIPO,
_cQry += Chr(13) + Chr(10) + "  	    E5_VALOR, 	    
_cQry += Chr(13) + Chr(10) + "  	    E5_NUMERO,
_cQry += Chr(13) + Chr(10) + "  	    E5_PREFIXO,
_cQry += Chr(13) + Chr(10) + "  	    E5_CLIFOR,
_cQry += Chr(13) + Chr(10) + "  	    E5_LOJA,
_cQry += Chr(13) + Chr(10) + "  	    E5.D_E_L_E_T_ DELETADO,
_cQry += Chr(13) + Chr(10) + " 		E5.R_E_C_N_O_,
_cQry += Chr(13) + Chr(10) + " 		CT2_LP,
_cQry += Chr(13) + Chr(10) + " 	    CTL_KEY,
_cQry += Chr(13) + Chr(10) + " 		CTL.R_E_C_N_O_ ,
...
_cQry += Chr(13) + Chr(10) + " 	   Left outer Join " + RETSQLNAME('CTL') + " CTL On CTL_LP = CT2_LP AND CTL.D_E_L_E_T_ = ' '
_cQry += Chr(13) + Chr(10) + " 	   Full outer Join ( select * from " + RETSQLNAME('SE5') + " E5 With(nolock)
_cQry += Chr(13) + Chr(10) + " 	                              Where E5_DTDISPO BetWeen '" + Dtos(mv_par01) + "' and '" +Dtos(mv_par02) + "'"
_cQry += Chr(13) + Chr(10) + " 	                                And D_E_L_E_T_ = ' ' " 
If Len(Alltrim(mv_par03)) > 0
	_cQry += Chr(13) + Chr(10) + " 	                            And  E5_TIPO in " + FormatIn(Alltrim(mv_par03),';')
EndIf
If Len(Alltrim(mv_par10)) > 0
 	_cQry += Chr(13) + Chr(10) + " 	                              And E5_MOTBX IN " + FormatIn(Alltrim(mv_par10),';')
EndIf
If Len(Alltrim(mv_par11)) > 0 
 	_cQry += Chr(13) + Chr(10) + " 	                              And E5_DOCUMEN LIKE '%" + mv_par11 + "%'"
EndIf
_cQry += Chr(13) + Chr(10) + " 	                              ) E5 ON E5_FILIAL+E5_TIPODOC+E5_PREFIXO+E5_NUMERO+E5_PARCELA+E5_TIPO+E5_DATA+E5_CLIFOR+E5_LOJA+E5_SEQ
_cQry += Chr(13) + Chr(10) + " 	                                = CT2_KEY AND CTL_LP IS NOT NULL
 
If mv_par08 == 01
  _cQry += Chr(13) + Chr(10) + " Where 
  _cQry += Chr(13) + Chr(10) + "     ( isnull(CT2_VALOR,0) != isnull(E5_VALOR,0)
  _cQry += Chr(13) + Chr(10) + " 	   Or E5.D_E_L_E_T_ = '*'
  _cQry += Chr(13) + Chr(10) + " 	)
EndIf
...
_cQRy := " Exec  FV_DIF_CTB_BAIXA" + cEmpAnt + " '" + Dtos(mv_par01) + "','" + Dtos(mv_par02) + "','" + mv_par05 + "','" + mv_par04 + "','" + mv_par03 + "','" + iIf(mv_par09 == 1,'D','C') + "','" + mv_par10 + "','" + mv_par11 + "','"+ IiF(mv_par08==01,'S','N') +"','" + IiF(MV_PAR12 == 01,'R','P') + "','" + iIf(mv_par13==01,"NA","EX") + "'"

MEMOWRITE('AACTBR06.SQL',_cQry)
//alert('espere')
...
PutSX1(cPerg,"10",PADR("Considerar MOT Baixas ",29)+" ","","","mv_chA","C",99,0,0,"G","","   ","","","mv_Par10")
PutSX1(cPerg,"11",PADR("Documento Contem ",29)+" ","","","mv_chB","C",99,0,0,"G","","   ","","","mv_Par11")

PutSX1(cPerg,"12", Padr("Carteira ",29) +"?", "", "" , "mv_chC" , "N" ,1, 0, 0, "C","","","","","mv_par12","Receber","Receber","Receber","","Pagar","Pagar","Pagar")
PutSX1(cPerg,"13", Padr("Tipo ",29) +"?", "", "" , "mv_chC" , "N" ,1, 0, 0, "C","","","","","mv_par13","Nacional","Nacional","Nacional","","Estrangeiro","Estrangeiro","Estrangeiro")
