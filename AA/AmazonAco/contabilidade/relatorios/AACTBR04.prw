...
User Function AACTBR04()
	
	u_XCTBR04()
	
Return

User Function XCTBR04()
	...
	Local Cabec1         := "      Fil.  Doc/Serie         Banco   Cliente/Loja-Nome          Emissao             Valor        Vlr.Real      Vlr. Taxa     Cupom "
	Local Cabec2         := ""
	...
	Private limite       := 132
	Private tamanho      := "G"
	Private nomeprog     := "AACTBR04" // Coloque aqui o nome do programa para impressao no cabecalho
	Private nTipo        := 18
	...
	Private CONTFL     := 01
	Private m_pag      := 01
	Private wnrel      := "AACTBR04" // Coloque aqui o nome do arquivo usado para impressao em disco
	
	Private cString := ""
	Private cPerg   := PADR("AACTBR04",Len(SX1->X1_GRUPO))
...
Static Function RunReport(Cabec1,Cabec2,Titulo,nLin)
	...
	if Mv_par11 == 01
		_cdFile   := AllTrim(mv_par12) + "\" + AllTrim(mv_par13) + ".xls"
...
Static Function getTable()
	...
	_cdQry += " DROR_BAIXAPORTIPO" + cEmpAnt + "('" + mv_par01 + "','" + mv_par02 + "','" + DTOS(mv_par03) + "','" + DTOS(mv_par04) + "','" + mv_par05 + "','" + mv_par05 + "','" + mv_par06 + "','" + mv_par07 + "','" + iIF(mv_par08 == 1,"R","P") + "') "
...
Static Function ValidPerg(cPerg)
	...
	PutSX1(cPerg,"06",PADR("Tipos a Considerar?",29) ,"","","mv_ch1","C",99,0,0,"G","","   ","","","mv_par06")
	PutSX1(cPerg,"07",PADR("Tipos a Desconsiderar?",29) ,"","","mv_ch1","C",99,0,0,"G","","   ","","","mv_par07")
	PutSX1(cPerg,"08",PADR("Carteira ?" ,29) ,"","","mv_ch1","N",01,0,0,"C","","   ","","","mv_par08","Receber","","","","Pagar","","","")
	
	PutSX1(cPerg,"09",PADR("Tipo de Relatorio?" ,29) ,"","","mv_ch1","N",01,0,0,"C","","   ","","","mv_par09","Analitico","","","","Sintetico")
	
	PutSX1(cPerg,"10",PADR("Quebra por Pagina?" ,29) ,"","","mv_ch1","N",01,0,0,"C","","   ","","","mv_par10","Sim","","","","Nao")		
	
	PutSX1(cPerg,"11", PADR("Gera Excel?" ,29) ,"","","mv_ch1","N",01,0,0,"C","","   ","","","mv_par11","Sim","","","","Não","","","")
	PutSX1(cPerg,"12", Padr("Diretorio ",29) +"?", "", "" , "mv_ch7" , "C" ,99, 0, 0, "G","","","","","mv_par12")
	PutSX1(cPerg,"13", Padr("Nome Arquivo",29) +"?", "", "" , "mv_ch8" , "C" ,99, 0, 0, "G","","","","","mv_par13")
