...
Static Function fRepPrint(oReport)
	...
	While ! QRY_REP->(Eof())
		...
		oSection:Cell("GRUPO"):SetValue(QRY_REP->GRUPO)
		oSection:Cell("FILIAL"):SetValue(QRY_REP->FILIAL)
		oSection:Cell("VALOR_TOTAL"):SetValue("R$  " + cValtoChar(QRY_REP->VALOR_TOTAL) )
		oSection:Cell("CD_ENTREGA"):SetValue(cValtoChar(QRY_REP->CD_ENTREGA)+" %" )
		oSection:Cell("CLIENTE_RETIRA"):SetValue(cValtoChar(QRY_REP->CLIENTE_RETIRA) +" %" )
		oSection:Cell("PRESENCIAL"):SetValue(cValtoChar(QRY_REP->PRESENCIAL)+" %" )
		oSection:Cell("WHATSAPP"):SetValue(cValtoChar(QRY_REP->WHATSAPP)+" %" )
		oSection:Cell("EMAIL"):SetValue(cValtoChar(QRY_REP->EMAIL)+" %" )
		oSection:Cell("REDE_SOCIAL"):SetValue(cValtoChar(QRY_REP->REDE_SOCIAL)+" %" )
		oSection:Cell("GOOGLE"):SetValue(cValtoChar(QRY_REP->GOOGLE)+" %" )
