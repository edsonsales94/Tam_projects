...
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
¦¦¦ Função    ¦ ICFATR05   ¦ Autor ¦ Diego Rafael         ¦ Data ¦   /  /2010 ¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
¦¦¦ Descriçäo ¦                                                               ¦¦¦
¦¦+-----------+---------------------------------------------------------------+¦¦
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	...
	Local imprime        := .T.
	Local aOrd           := {}
	Local cPerg          := PadR("AAFATR16",Len(SX1->X1_GRUPO))
	Private lEnd         := .F.
	Private lAbortPrint  := .F.
	Private CbTxt        := ""
	Private limite       := 220
	Private tamanho      := "G"
	Private nomeprog     := "AAFATR16" // Coloque aqui o nome do programa para impressao no cabecalho
	Private nTipo        := 18
	...
	Private CONTFL       := 01
	Private m_pag        := 01
	Private wnrel        := "AAFATR16" // Coloque aqui o nome do arquivo usado para impressao em disco
	Private aCabec       := {}
	Private cString      := ""
...
Static Function MountTable(cTable)
	...
	cQry += Chr(13) + Chr(10) + " INNER JOIN " + RetSqlName("SB1") +" SB1 ON B1_COD = D3_COD AND B1_FILIAL = '" + xFilial('SB1') + "' AND SB1.D_E_L_E_T_ = ' ' "
