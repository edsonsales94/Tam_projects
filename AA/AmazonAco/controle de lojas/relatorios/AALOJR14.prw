...
¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦                          
¦¦¦ Função    ¦ AALOJR14   ¦ Autor ¦ Autor!!!!            ¦ Data ¦ xx/xx/20xx ¦¦¦
¦¦+-----------+------------+-------+----------------------+------+------------+¦¦
...
Local cDesc3         := ""
Local cPict          := ""
Local titulo         := "Resumo Recebimentos Analitico"
Local nLin           := 80
Local Cabec1         := ""
Local Cabec2         := ""
Local imprime        := .T.
Local aOrd           := {} 
Local cPerg          := PadR("AALOJR14",Len(SX1->X1_GRUPO))
Private lEnd         := .F.
Private lAbortPrint  := .F.
Private CbTxt        := ""
Private limite       := 220
Private tamanho      := "G"
Private nomeprog     := "AALOJR14" // Coloque aqui o nome do programa para impressao no cabecalho
Private nTipo        := 18
...
Private CONTFL       := 01
Private m_pag        := 01
Private wnrel        := "AALOJR14" // Coloque aqui o nome do arquivo usado para impressao em disco
Private aCabec       := {}
Private cString      := ""
...
cQry += Chr(13) + Chr(10) + " SELECT D2_SERIE E1_PREFIXO, D2_DOC E1_NUM, D2_EMISSAO E1_EMISSAO, D2_CLIENTE E1_CLIENTE , A1_NOME,'RES' E1_TIPO, 'RESERVA' X5_DESCRI , ISNULL(SUM(D2_TOTAL+D2_ICMSRET),0) VALOR FROM " + RetSqlName("SD2") +" SD2 WITH (NOLOCK) "
...
cQry += Chr(13) + Chr(10) + " AND SUBSTRING(D2_CF,2,3) IN ('101','102','401','405','107','108','109','110','403','404','122','118','119') "
