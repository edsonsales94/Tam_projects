...
Static Function FSAtuSX3()
	...
	aAdd( aSX3, {__AliCXML,'02',__PrefCXML+'_CODIGO','C',6 ,0,'Codigo','Codigo','Codigo','','','','','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'GETSXENUM("'+__AliCXML+'","'+__PrefCXML+'_CODIGO")','',0,Chr(254) + Chr(192),'','','U','S','V','R','€','','','','','','','','','','','','','N','','','N','',''} )
	...
	aAdd( aSX3, {__AliCXML,'05',__PrefCXML+'_TIPO'  ,'C',1 ,0,'Tipo','Tipo','Tipo','','','','','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','S','A','R','€','','1=Manual;2=Automatico','','','','','','','','','','','N','','','N','',''} )
	...
	//aAdd( aSX3, {__AliCXML,'07',__PrefCXML+'_FRACIO','C',1 ,0,'Fragmenta?','Fragmenta?','Fragmenta?','','','','','',Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) +Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160),'','',0,Chr(254) + Chr(192),'','','U','S','A','R','','','1=Sim;2=Nao','','','','','','','','','','','N','','','N','',''} )
...
Static Function MyOpenSM0(lShared)
	...
	For nLoop := 1 To 20
		...
		// DbUseArea( .T., "TOPCONN", RetSqlName("SM0"),'SM0', lShared, .F. )
...
Static Function fParams()
	...
	aAdd( aParams, {'XX_MAXURL' ,'Caracter'	,'Link principal do endpoint'               	 		,'aaaa'} )
	aAdd( aParams, {'XX_MAXPASS','Caracter'	,'Senha' 		   			 					 		,'bbbb'} )
	aAdd( aParams, {'XX_MAXUSER','Caracter'	,'Login'					 							,'cccc'} )
	aAdd( aParams, {'XX_MAXGET' ,'Caracter'	,'Link para envio do GET'		 						,'dddd'} )
	aAdd( aParams, {'XX_CONDPAG','Caracter'	,'Condicao padrao quando o cliente nao tem condicao'	,'eeee'} )
	aAdd( aParams, {'XX_TABELA'	,'Caracter'	,'Tabela de preço padrão quando cliente não possiu' 	,'ffff'} )
	aAdd( aParams, {'XX_TAB1'   ,'Caracter'	,'Cabecalho de cadastro de EndPoint'					,'Z98'} )
	aAdd( aParams, {'XX_TAB2'	,'Caracter'	,'Itens do cadastro de EndPoints' 						,'Z99'} )
