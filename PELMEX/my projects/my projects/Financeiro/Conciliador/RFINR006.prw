...
static function ajustaSx1(cPerg)       
	u_InputSx1(cPerg, "01", "De Filial          ?"  , "", "", "mv_ch1", "C",06,00,00, "G", "","SM0", "", "", "mv_par01")
	u_InputSx1(cPerg, "02", "Até Filial         ?"  , "", "", "mv_ch2", "C",06,00,00, "G", "","SM0", "", "", "mv_par02") 
	u_InputSx1(cPerg, "03", "De Cliente         ?"  , "", "", "mv_ch3", "C",14,00,00, "G", "","SA1", "", "", "mv_par03")
	u_InputSx1(cPerg, "04", "Até Cliente        ?"  , "", "", "mv_ch4", "C",14,00,00, "G", "","SA1", "", "", "mv_par04")           
	u_InputSx1(cPerg, "05", "De Vendedor        ?"  , "", "", "mv_ch5", "C",06,00,00, "G", "","SA3", "", "", "mv_par05")   
	u_InputSx1(cPerg, "06", "Até Vendedor       ?"  , "", "", "mv_ch6", "C",06,00,00, "G", "","SA3", "", "", "mv_par06")  
	u_InputSx1(cPerg, "07", "De Gerente         ?"  , "", "", "mv_ch7", "C",06,00,00, "G", "","SA3", "", "", "mv_par07") 	
	u_InputSx1(cPerg, "08", "Até Gerente        ?"  , "", "", "mv_ch8", "C",06,00,00, "G", "","SA3", "", "", "mv_par08") 	
	u_InputSx1(cPerg, "09", "De Emissão         ?"	, "", "", "mv_ch9", "D",08,00,00, "G", "",   "", "", "", "mv_par09")
	u_InputSx1(cPerg, "10", "Até Emissão        ?"	, "", "", "mv_chA", "D",08,00,00, "G", "",   "", "", "", "mv_par10")  
	u_InputSx1(cPerg, "11", "Operadora          ?"	, "", "", "mv_chB", "C",03,00,00, "G", "",   "", "", "", "mv_par11")
	u_InputSx1(cPerg, "12", "Exceto Estado      ?"	, "", "", "mv_chC", "C",30,00,00, "G", "",   "", "", "", "mv_par12")
	u_InputSx1(cPerg, "13", "Analitico/Sintetico?"	, "", "", "mv_chD", "N",01,00,02, "C", "",   "", "", "", "mv_par13", "Analitico", "", "",  "", "Sintetico", "")
