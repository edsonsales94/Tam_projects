#include "rwmake.ch"   // incluido pelo assistente de conversao do AP6 IDE em 09/07/03

User Function ETQPEL2()
	...
	SetPrvt("LPRIM,LCOND,MCODPRO,MDESCRI,MNROETIQ")
	SetPrvt("MOP,CSENGRV")
	...
	While lCond
		...
		@ 0,0 TO 250,475 DIALOG oECol TITLE "Impressao de Etiquetas - Camas"
		...
		@ 100,145 BMPBUTTON TYPE 02 ACTION (lCond:=.F.,Close(oECol))
...
Static Function PegaSenha()
	Local cTexto, vUsu, cSenGrv, i, cProc, nPos, x
...
Static Function Imprime()
	...
	Local ContaEtq, No_Chassis, mCod1, mCod2, cPorta := ""
	...
	While ContaEtq <= mNroEtiq
		...
		mCod1 := AllTrim(mCodPro)+" "+SB1->B1_Cor+" "+SB1->B1_Chassis
		mCod2 := mCodPro+SB1->B1_Cor+SB1->B1_Chassis

		MsCbBegin(1,4,106.5)

		MsCbSay(09,15,mCod1,"B","4","01","01")
		MsCbSayBar(30,00,mCod2,"B","A",20,.F.,.F.,.F.,,5,1.5,.F.,.F.,"1",.T.)

		MsCbSay(37,15,mCod1,"B","4","01","01")
		MsCbSayBar(58,00,mCod2,"B","A",20,.F.,.F.,.F.,,5,1.5,.F.,.F.,"1",.T.)
