...
User Function FIXREINF()
    ...
    Private cDtIni      := "20230801" //Data inicial a ser considera para filtrar a emissão dos títulos (Formato AAAAMMDD)
...
Static Function FIXFKW(cFil,cDoc,cSer,cFor,cLoj)
   ...
   // oFindE2:SetString(1,cFil)
    oFindE2:SetString(1,cFor)
    oFindE2:SetString(2,cLoj)
    oFindE2:SetString(3,GetAdvFVal("SF1","F1_PREFIXO", cFil + cDoc + cSer + cFor + cLoj,1))
    oFindE2:SetString(4,cDoc)
    oFindE2:SetString(5,MVNOTAFIS)
